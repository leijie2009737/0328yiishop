		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="http://admin.yiishop.com<?=$goods_gallery['0']->path?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="http://admin.yiishop.com<?=$goods_gallery['0']->path?>" alt="" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
								...
								<li>
									<a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'http://admin.yiishop.com<?=$gallery->path?>',largeimage: 'http://admin.yiishop.com<?=$gallery->path?>'}"><img src="http://admin.yiishop.com<?=$gallery->path?>"></a>
								</li>
                                <?php endforeach;?>
